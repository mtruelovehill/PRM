...
+ ANOVAs produce an $F$-statistic that reflects the ratio of the variation in the dependent variable explained by our independent variable(s) and the variation explained by other unmeasured factors.
...
ggplot(data = data.frame(f = c(0, 5)), aes(x=f)) +
  ...
  stat_function(fun=df, geom='line', args=c(df1 = 5, df2 = 30), color = accent2, linewidth=1.5) +
  xlab('t') +

...
+ Specifically, we can use probability distributions to compute the probability of value at (or more extreme than) a specific point on the distribution. 
...
+ The statistical tests we will learn about in this course all involve testing the probability of a specific value of a test statistic, given that $H_0$ is true. 

+ In other words, if $H_O$ is true, how likely is it that we would get results at least as extreme as ours?

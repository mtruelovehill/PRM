...
normDist + geom_vline(xintercept = 0, color=accent1) + 
  ...
  stat_function(fun=dnorm, geom = "line", args = list(mean = -2), linewidth = 1.5, color = accent3) +
  annotate(geom='text', label=paste0('mu == -2'), parse = T, x=-5, y=0.32, size = 6, colour = accent3, hjust = 0) +
...
normDist + geom_vline(xintercept = 0, color=accent1) + 
  ...
  stat_function(fun=dnorm, geom = "line", args = list(sd = 1.5), linewidth = 1.5, color = accent3) +
  annotate(geom='text', label=paste0('mu == -2'), parse = T, x=-5, y=0.61, size = 6, colour = accent3, hjust = 0) +
...
ggplot(skewDat, aes(x)) + geom_histogram(aes(y=after_stat(density)), fill = baseColor, color = 'gray32', binwidth=2) +
  geom_density(linewidth=1) +
  geom_vline(xintercept = mean(skewDat$x), color = accent1, linewidth = 1) +
  geom_vline(xintercept = median(skewDat$x), color = accent2, linewidth = 1) +
  geom_vline(xintercept = round(Mode(skewDat$x),2), color = accent3, linewidth = 1) +
...
ggplot(platDat, aes(x)) + geom_histogram(aes(y=after_stat(density)), fill = baseColor, color = 'gray32', binwidth=2) +
...
ggplot(leptDat, aes(x)) + geom_histogram(aes(y=after_stat(density)), fill = baseColor, color = 'gray32', binwidth=1) +

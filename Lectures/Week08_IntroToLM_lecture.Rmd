...
.pull-right[
```{r, echo = F, fig.height=3.25, fig.width=7}
...
```{r, echo = F, fig.width=7, fig.height=3.25}
...
```{r, echo = 5, fig.height=4, fig.width=7}
p4
```
...
.center[
```{r, echo = F, message = F, warning = F, fig.height=4.25, fig.width = 9}
set.seed(504)
...
lrPlot + 
  ...
  annotate(geom='segment', x = dat$StudyHours, xend = dat$StudyHours, y = 43, yend = dat$CourseAverage, color = baseColor, 
           linetype = 'dashed')
```
]]
...
lrPlot + 
  ...
  annotate(geom = 'text', label = dat$yLabs, x = dat$StudyHours + .15, y = dat$CourseAverage, color = baseColor, 
           size = 5, fontface = 'bold') + 
  annotate(geom='segment', x = 1.38, xend = dat$StudyHours, y = dat$CourseAverage, yend = dat$CourseAverage, color = baseColor, 
           linetype = 'dashed')
```
]]

...
|Group | Value | Rank |
|:----:|:-----:|:----:|
| B    |  12   | <span style = "font-weight: bold; color: #18778C"> 1 </span>|
| B    |  8    | <span style = "font-weight: bold; color: #18778C"> 2 </span>|
| A    |  7    | <span style = "font-weight: bold; color: #9AD079"> 3 </span>|
| B    |  6    | <span style = "font-weight: bold; color: #18778C"> 4 </span>|
| A    |  5    | <span style = "font-weight: bold; color: #9AD079"> 5 </span>|
| A    |  4    | <span style = "font-weight: bold; color: #9AD079"> 6 </span>|
| A    |  3    | <span style = "font-weight: bold; color: #18778C"> 7 </span>|
| B    |  2    | <span style = "font-weight: bold; color: #9AD079"> 8 </span>|
...
+ For group comparisons & $\chi^2$:

```{r, echo = F, out.width='80%'}
knitr::include_graphics('images/nonparTestsSPSS.png')
```

---
## Nonparametric Tests in SPSS

+ For associations with Spearman's $\rho$:

```{r, echo = F, out.width='70%'}
knitr::include_graphics('images/SpearmanSPSS.png')
```
...
.pull-left[
```{r, echo = F}
knitr::include_graphics('images/bernie.png')
```
]
...
```{r, echo = F}
knitr::include_graphics('images/QRCode for PRM End-of-Semester Feedback 25_26.png')
```

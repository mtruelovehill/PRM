...
+ Homogeneity of Variance
  ...
  + Typical suggestion is to use Levene's test; however, this may also be problematic (see [Delacre et al., 2017](https://rips-irsp.com/articles/10.5334/irsp.82))
  + Instead, may default to Welch's $t$-test
...
+ In the Statistical Analysis portion of the methods, you should specify $\alpha$
...
> **Test your Critical Thinking:** Why do you not need to check for homogeneity of variance in a paired-samples $t$-test?

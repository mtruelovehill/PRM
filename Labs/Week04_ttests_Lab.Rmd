...
```{r, echo = F, fig.align= 'center'}
knitr::include_graphics('images/week4_5b.png')
```
...
```{r, echo = F, fig.align= 'center', out.width='75%'}
knitr::include_graphics('images/week4_5d.png')
```
...
```{r, echo = F, fig.align= 'center', out.width='75%'}
knitr::include_graphics('images/week4_7a.png')
```

Perform the normality tests from [Study 1: Check Assumptions] with this new variable.

```{r, echo = F, fig.align= 'center', out.width='50%'}
knitr::include_graphics('images/week4_7c.png')
```

```{r, echo = F, fig.align= 'center', out.width='75%'}
knitr::include_graphics('images/week4_7b.png')

knitr::include_graphics('images/week4_7d.png')
```
...
```{r, echo = F, fig.align= 'center', out.width='75%'}
knitr::include_graphics('images/week4_8a.png')
```
...
```{r, echo = F, fig.align= 'center', out.width='75%'}
knitr::include_graphics('images/week4_8b.png')
```

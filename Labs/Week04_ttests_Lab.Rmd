...
```{r, echo=F, fig.align='center'}
knitr::include_graphics('images/week4_3b.png')
```
...
quiz(caption = 'Test Your Understanding',
     ...
     question_numeric('What percentage of parent participants were male?',
...
```{r, echo = F, fig.align= 'center'}
knitr::include_graphics('images/week4_4a.png')
```
...
knitr::include_graphics('images/week4_4b.png')
```
...
```{r, echo = F, fig.align= 'center'}
knitr::include_graphics('images/week4_4h.png')
```
...
quiz(caption = 'Test Your Understanding',
     question("At least one of the variables violates an assumption",
              ...
              answer("False"),
              message = 'The Parent Vocalisations variable violates the Homogeneity of Variance assumption.'),
     question("Which of the following can be used to assess normality? Please select all that apply.",
...
```{r, echo = F, fig.align= 'center', out.width='75%'}
knitr::include_graphics('images/week4_5a.png')
```
...
```{r, echo = F, fig.align= 'center'}
knitr::include_graphics('images/week4_5bi.png')
```
...
```{r, echo = F, fig.align= 'center'}
knitr::include_graphics('images/week4_5bii.png')
```
...
```{r, echo = F, fig.align= 'center', out.width='75%'}
knitr::include_graphics('images/week4_5c.png')
```
...
quiz(caption = 'Test Your Understanding',
     question_numeric("What is the t-value associated with infant vocalisation? Please round your answer to two decimal places.",
              answer(-3.80, correct = T),
              message = 'The t-value associated with this test is -3.80.'),

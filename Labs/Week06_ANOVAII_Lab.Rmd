...
Have a look at the [lecture slides](Week05_ANOVAII_lecture.html) if you're lost.
...
<details><summary><span style = "font-weight: bold; font-size: 16pt"> Click here for a hint </span></summary>
<br>
This power analysis requires/outputs the total number of participants, rather than the number of participants per group. 
...
While you can produce plots in SPSS, they often don't meet APA standards and are difficult to customise. One method that you can use to produce more effective figures is the `ggplot2` package in R. While this would typically require some coding, the website, [ggplot GUI](https://shiny.gmw.rug.nl/ggplotgui/) provides an application that allows you to produce plots with point-and-click options. 

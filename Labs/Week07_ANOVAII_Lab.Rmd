...
These look normal. There's a slight point in the right tail of the Baseline residuals that isn't quite normal, but it's not problematic. The Q-Q plots can also be checked. Navigate to *Analyze>Descriptive Statistics>Q-Q Plots* and add the two residual columns to the 'Variable(s)' box. Click 'OK'. 
...
```{r, echo = F, fig.align= 'center', out.width='50%'}
knitr::include_graphics('https://mtruelovehill.github.io/PRM/Labs/images/anovaII_resVpred1.png')
```

Repeat the process with `ZRE_2` and `PRE_2`:

```{r, echo = F, fig.align= 'center', out.width='50%'}
knitr::include_graphics('https://mtruelovehill.github.io/PRM/Labs/images/anovaII_resVpred2.png')
```

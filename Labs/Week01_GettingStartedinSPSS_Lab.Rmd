...
<ul>
    <li> <dt> <input type="checkbox"> Import 'Week1LabData.csv' into SPSS. </dt> </li>
    <li> <dt> <input type="checkbox"> Once you have imported the file, save it as 'Week1LabData_SPSS' in the folder of your choice on your device. </dt> </li>
</ul>


+ [ ] $\ $ Import 'Week1LabData.csv' into SPSS. 
+ [ ] $\ $ Once you have imported the file, save it as 'Week1LabData_SPSS' in the folder of your choice on your device. 

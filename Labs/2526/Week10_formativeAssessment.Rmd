...
quiz(caption = '',
     ...
     question("In which of the following cases would Pearson's correlation be most useful?",
              answer('To test the association between two continuous variables', correct = T),
              answer('To test the association between two ordinal variables'),
              answer('To test whether one continuous variable predicts another'),
              answer('To test whether there is a difference between two groups'),
              answer('To test whether there is a difference between three or more groups'),
              random_answer_order = T,
              message = "Correlations can be used to test for an association between two variables. Pearson's correlation should be used when the two variables are continuous and normally distributed. Spearman's correlation is the nonparametric alternative, and should be used when data are not continuous or when they are not normally distributed."),
     ...
     question('You are testing the effects of parental involvement and bullying on emotional regulation in children. Parental involvement is measured by the number of parental interactions per week, and bullying as the number of times the child is bullied per week. Assume that emotional regulation is measured on a continuous scale. Which of the following analyses would best test for these effects?',
              answer('One-Sample t-test'),
              answer('independent-samples t-test'),
              answer('paired-samples t-test'),
     ...
     question('You are testing for group differences in nurse stress based on hospital size. You compare stress levels in nurses across 3 different hospital sizes (small, medium, and large). Assume that stress is a continuous variable. Which of the following analyses could be used to to test this association?',
              answer('One-Sample t-test'),
              answer('independent-samples t-test'),
              answer('paired-samples t-test'),
...
quiz(caption = '',
     question("True or False: We can test for the independence of observations using a qqplot.",
              answer('True'),

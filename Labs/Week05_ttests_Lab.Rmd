...
4. Interpret results from an independent-samples $t$-test
...
4. Conduct an appropriate power analysis for a paired-samples $t$-test.
...
**You can download the dataset from the first experiment [here.](https://mtruelovehill.github.io/PRM/Labs/ttestLabData.sav)** This dataset contains the following variables:
...
To calculate descriptive statistics, navigate to *Analyze > Descriptive Statistics > Frequencies*. You'll need to check the mean, standard deviation, minimum, and maximum for continuous data and create frequency tables for categorical data.

...
#### Experiment 1
In the first experiment, you investigated whether the region of the face covered affects a child's ability to recognize emotions conveyed by facial expressions. You recruited a sample of primary-school aged children. All participants were presented with photos of people making stereotypical facial expressions associated with 5 different emotions (happiness, sadness, fear, anger, disgust). However, participants were grouped into one of three conditions. In the first condition, stimuli were unobstructed. In the second condition, stimuli were wearing sunglasses so that the eyes were obstructed. In the third condition, stimuli were wearing masks so that the mouth was obstructed (see examples below).

```{r, echo = F}
knitr::include_graphics('images/Week5_expStimuli.png')
```

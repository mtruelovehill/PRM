...
MONICA - Check Simpson's paradox in iris dataset (sepal.width & petal.length when you do and don't account for species). Add Hamdullah's image for sphericity decision. 

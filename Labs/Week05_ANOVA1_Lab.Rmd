...
knitr::include_graphics('images/week5_IVnum.png')
```
...
```{r, echo = F, fig.align= 'center'}
knitr::include_graphics('images/week5_ANOVA.png')
```
...
```{r, echo = F, fig.align= 'center'}
knitr::include_graphics('images/week5_effectSize.png')
```
...
```{r, echo = F, fig.align= 'center'}
knitr::include_graphics('images/week5_posthocs.png')
```
...
```{r, echo = F, fig.align= 'center', out.width='75%'}
knitr::include_graphics('images/week5_RMdesc.png')
```
...
```{r, echo = F, fig.align= 'center', out.width='50%'}
knitr::include_graphics('images/week5_happinessHist.png')
knitr::include_graphics('images/week5_sadnessHist.png')
knitr::include_graphics('images/week5_fearHist.png')
knitr::include_graphics('images/week5_angerHist.png')
knitr::include_graphics('images/week5_disgustHist.png')
```
...
```{r, echo = F, fig.align= 'center', out.width='50%'}
knitr::include_graphics('images/week5_happinessQQ.png')
knitr::include_graphics('images/week5_sadnessQQ.png')
knitr::include_graphics('images/week5_fearQQ.png')
knitr::include_graphics('images/week5_angerQQ.png')
knitr::include_graphics('images/week5_disgustQQ.png')
```
...
```{r, echo = F, fig.align = 'center', out.width='75%'}
knitr::include_graphics('images/week5_mauchley.png')
```
...
```{r, echo = F, fig.align= 'center', out.width='50%'}
knitr::include_graphics('images/week5_RMfactors.png')
```
...
```{r, echo = F, fig.align= 'center', out.width='75%'}
knitr::include_graphics('images/week5_RMeffects.png')
```
...
```{r, echo = F, fig.align= 'center', out.width='75%'}
knitr::include_graphics('images/week5_pwc.png')
```
...
```{r, echo = F, fig.align= 'center', out.width='40%'}
knitr::include_graphics('images/week5_emotionKey.png')
```
...
```{r, echo = F, fig.align= 'center', out.width='50%'}
knitr::include_graphics('images/week5_RMTable.png')
```
...
```{r, echo = F, fig.align='center'}
knitr::include_graphics('images/week5_RMpowerChoice.png')
```
<br>
...
```{r, echo = F, fig.align='center'}
knitr::include_graphics('images/week5_RMpower.png')
```

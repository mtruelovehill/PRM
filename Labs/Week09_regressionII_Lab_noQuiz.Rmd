...
```{r cyrAnalysis, echo = FALSE, eval = F}
quiz(caption = 'Check Your Results',
     ...
     question("Which of the following interpretations are correct? Please select all that apply.",
              answer('For every additional hour of sleep a participant gets per week, their well-being score will increase by 0.37, when social support is held constant and someone gets an average amount of physical activity', correct=T),
              ...
              answer('The interaction between sleep and physical activity explains 37% of the variance in student well-being.'),
              ...
              message = "The overall model, rather than just the interaction, explains 37% of the variance in well-being. As one's social support score increases by 1 point, their well-being score will increase by .06 point, when sleep and physical activity are held constant. The interpretation of the interaction, while a bit convoluted, is accurate. Additionally, the interpretation of sleep's effect on well-being is accurate. The beta-coefficient for sleep is the association between sleep and well-being when physical activity is average because physical activity is mean-centered. As social support is not mean-centered and it is not part of the interaction, the beta-coefficient reflects the association between sleep and well-being when it is held constant.",
              random_answer_order = T),

...
In this course, jamovi will be used to perform the majority of your tasks. You can download today's data onto your device by <B>[clicking here](https://mtruelovehill.github.io/PRM/Labs/ExploringDataLabData.csv)</B> or checking this week's folder on <b>[the course Learn page (requires university login)](https://www.learn.ed.ac.uk/)</b>.

...
You can download the data for this week's lab [here.](https://mtruelovehill.github.io/PRM/Labs/Week6LabData.sav)
...
knitr::include_graphics('https://mtruelovehill.github.io/PRM/Labs/images/week6_updateFreqTables.png')
```
...
knitr::include_graphics('https://mtruelovehill.github.io/PRM/Labs/images/week6_updateDescStat.png')
```
...
```{r, echo = F, fig.align= 'center', out.width = '50%'}
knitr::include_graphics('https://mtruelovehill.github.io/PRM/Labs/images/week6_ageHist.png')
```

```{r, echo = F, fig.align= 'center', out.width = '50%'}
knitr::include_graphics('https://mtruelovehill.github.io/PRM/Labs/images/week6_baselineHist.png')
```

```{r, echo = F, fig.align= 'center', out.width = '50%'}
knitr::include_graphics('https://mtruelovehill.github.io/PRM/Labs/images/week6_followUpHist.png')
```
...
To check the assumptions of normality and homogeneity, you'll need to run your ANOVA. See the Solution tab in [Experiment 1 Analysis] if you need a step-by-step guide on setting up your test. Once you have your test set up, click the 'Save' option, and tick the Residuals box beside 'Standardized'.

```{r, echo = F, fig.align= 'center', out.width='50%'}
knitr::include_graphics('https://mtruelovehill.github.io/PRM/Labs/images/week6_testSetupSave.png')

knitr::include_graphics('https://mtruelovehill.github.io/PRM/Labs/images/week6_residuals.png')
```
...
```{r, echo = F, fig.align= 'center', out.width='50%'}
knitr::include_graphics('https://mtruelovehill.github.io/PRM/Labs/images/week6_histRes1.png')

knitr::include_graphics('https://mtruelovehill.github.io/PRM/Labs/images/week6_histRes2.png')
```
...
```{r, echo = F, fig.align= 'center', out.width='50%'}
knitr::include_graphics('https://mtruelovehill.github.io/PRM/Labs/images/week6_levenesTest.png')
```
...
To run a Factorial ANOVA with a within-subjects variable, you should navigate to *Analyze>General Linear Model>Repeated Measures*. If you only had between-subjects variables, you would navigate to *Analyze>General Linear Model>Multivariate*.
...
```{r, echo = F, fig.align= 'center', out.width = '50%'}
knitr::include_graphics('https://mtruelovehill.github.io/PRM/Labs/images/week6_RMfactors.png')
```
...
```{r, echo = F, fig.align= 'center', out.width = '50%'}
knitr::include_graphics('https://mtruelovehill.github.io/PRM/Labs/images/week6_modelPlot.png')
```
...
```{r, echo = F, fig.align= 'center', out.width = '50%'}
knitr::include_graphics('https://mtruelovehill.github.io/PRM/Labs/images/week6_emMeans.png')
```

Click 'Continue'. If you haven't already, you'll need to produce the residuals from your model so that you can check normality. Click 'Save', then tick the Residuals box beside 'Standardized'. See [Experiment 1 Assumptions] for more information.
...
knitr::include_graphics('https://mtruelovehill.github.io/PRM/Labs/images/week6_FAdescStats.png')
```
...
```{r, echo = F, fig.align= 'center', out.width = '75%'}
knitr::include_graphics('https://mtruelovehill.github.io/PRM/Labs/images/week6_wsEffects.png')
```
...
```{r, echo = F, fig.align= 'center', out.width = '75%'}
knitr::include_graphics('https://mtruelovehill.github.io/PRM/Labs/images/week6_interaction.png')
```
...
```{r, echo = F, fig.align= 'center', out.width = '75%'}
knitr::include_graphics('https://mtruelovehill.github.io/PRM/Labs/images/week6_interactionPlot.png')
```
...
+ [ ] $\ $ Run a **sensitivity** power analysis using $\alpha$ = .05 and power = .8 to determine the effect size you're able to detect with a sample size of 100 for the main effect of `TherapyGroup`. 
...
quiz(caption = 'Check Your Results',
     question_numeric("What is the numerator df associated with the interaction effect? ",
              answer(1, correct = T),
              message = "The numerator df for the interaction is 1. See the solution tab for how this is calculated."),
     ...
     question_numeric("What is the minimum effect of TherapyGroup (eta-squared) you can detect with 100 participants, 80% power and alpha = .05?",
              answer(.07, correct = T),
...
The numerator df for the interaction effect is calculated by $(J-1)\times(K-1)$, where:

J = number of levels in Independent Variable 1 (`Time`)

K = number of levels in Independent Variable 1 (`TherapyGroup`)

The numerator df for the main effects is then calculated by $J-1$ for the main effect of `Time` and $K-1$ for the main effect of `TherapyGroup`. 

If you're completely lost, you might find the help section on [WebPower ](https://webpower.psychstat.org/wiki/manual/power_of_nanova) useful.
...
Navigate to the WebPower site and click Two-Way and Three-Way ANOVA with interaction:

```{r, echo = F, fig.align='center', out.width='50%'}
knitr::include_graphics('https://mtruelovehill.github.io/PRM/Labs/images/week6_powerOptions.png')
```
<br>
<i> Number of groups </i> refers to the number of independent groups you're comparing. You can compute this by multiplying the total number of levels within each independent variable. In this case, you have 2 levels in `Time` (Baseline; Follow-up) and 2 levels in `TherapyGroup` (Waitlist; VR Therapy), so your total number of groups is:
...
In this example, the numerator df would be:

$$(2-1)\times(2-1) = 1$$

You'll leave the Sample Size option blank, as that's the value you want to calculate. To compute the effect size, $f$, you'll do the following:
...
```{r, echo = F, fig.align='center', out.width='50%'}
knitr::include_graphics('https://mtruelovehill.github.io/PRM/Labs/images/week6_interactionPower.png')
```
...
<i> Number of groups </i> refers to the number of groups you're comparing. In this case, you have 2 levels in `Time` (Baseline; Follow-up).

The numerator df for the main effect is then calculated by $J-1$, where $J = $ number of levels in `Time`. In this case, that would be 1.
...
```{r, echo = F, fig.align='center', out.width='50%'}
knitr::include_graphics('https://mtruelovehill.github.io/PRM/Labs/images/week6_me1Power.png')
```

To detect the main effect of `Time` with the given constraints, you need 128 participants.

<span style = "font-weight: bold; font-size: 14pt"> Main Effect of Therapy Group </span>

Navigate to the WebPower site and click Two-Way and Three-Way ANOVA with interaction.

<i> Number of groups </i> refers to the number of groups you're comparing. In this case, you have 2 levels in `TherapyGroup` (Baseline; Follow-up).

The numerator df for the main effect is then calculated by $J-1$, where $J = $ number of levels in `TherapyGroup`. In this case, that would be 1.

Your sample size is 100. You'll leave the effect size option blank, as that's the value you want to calculate.

You can enter in the appropriate values for $\alpha$ and power. When you're finished, click 'Calculate' and you should see the following results if you've entered everything properly:

```{r, echo = F, fig.align='center', out.width='50%'}
knitr::include_graphics('https://mtruelovehill.github.io/PRM/Labs/images/week6_me2Power.png')
```

You have an effect size, $f$, which is equal to .28, but this needs to be converted to $\eta^2$. To do this, you can use the formula:


$$\eta^2 = \frac{f^2}{1+f^2} = \frac{.28^2}{1+.28^2} = \frac{.08}{1+.08} = .07$$

For the main effect of `Time`, if you had 100 participants, the minimum effect you would be able to detect with 80% power and $\alpha$ = .05 is $\eta^2$ = .07, which equates to a moderate effect. If the effect of `Time` on CAPS score is smaller than .07, your power level would be less than 80%.
...
In this study, we tested a novel virtual-reality (VR) therapy method for the treatment of post-traumatic stress disorder. We split participants into two groups; one group was placed on a waitlist, while the other group received VR therapy. We measured PTSD symptoms using Clinician-Administered PTSD Scale (CAPS) scores at baseline, and again after treatment. We hypothesised that there would be a difference in CAPS scores across therapy groups, and that this difference would be dependent upon time. To test this, we performed a 2x2 Factorial ANOVA with both one within-subjects variable, Time (levels: baseline; follow-up), and one between-subjects variable, therapy group (levels: Waitlist, VR Therapy) as independent variables and CAPS score as the dependent variable. $\alpha$ was set at .05 for all analyses. An a priori power analysis indicated that 128 participants were sufficient to detect a moderate interaction effect ($\eta^2$ = .06) with 80% power and $\alpha$ = .05 using this analysis.

Our original sample consisted of 133 participants. However, 2 participants withdrew from the study before follow-up; they were excluded from further analysis. Our final sample consisted of 131 participants between the ages of 18 and 73 ($M$ = 45.70, $SD$ = 16.48; 63 females, 68 males). The normality assumption was checked through visual assessment of the QQ-plots and histograms. The homogeneity of variance assumption was checked using Levene's test. The data met all assumptions.

There was a significant effect of Therapy Group on CAPS score, $F$(1, 129) = 6.90, $p$ = .010, $\eta^2$ = .05. Specifically, participants in the waitlist group had higher CAPS scores than those in the VR therapy group. The effect of Time on CAPS scores was not significant, $F$(1, 129) = 3.21, $p$ = .076, $\eta^2$ = .024. 

There was a significant interaction between Time and Therapy Group on CAPS score, $F$(1, 129) = 17.01, $p$ < .001, $\eta^2$ = .12. Simple effects analyses indicated that while there was no significant effect of therapy group at baseline, $F$(1, 129) = 0.04, $p$ = .834, those in the waitlist group had significantly higher CAPS scores than those in the VR therapy group at follow-up, $F$(1, 129) = 16.50, $p$ < .001, $\eta^2$ = .11. See Table 1 for descriptive data for each group.

```{r, echo = F, fig.align='center', out.width='50%'}
knitr::include_graphics('https://mtruelovehill.github.io/PRM/Labs/images/week6_descTable.png')
```
...
Note that you can also put results from ANOVA tests into a table. If you do this, you don't need to also put them into text. Here is an example of an APA-style ANOVA table:

```{r, echo = F, fig.align='center', out.width='50%'}
knitr::include_graphics('https://mtruelovehill.github.io/PRM/Labs/images/week6_ANOVAtable.png')
```
...
## Bonus Material: Using ggplot for visualisation

You can produce plots in SPSS, but they often don't meet APA standards and can be complicated to customise. One method that you can use to produce more effective figures is the `ggplot2` package in R. While this would typically require some coding, the [ggplot GUI website](https://shiny.gmw.rug.nl/ggplotgui/) provides an application that allows you to produce ggplot figures with point-and-click options. 

In order for the application to work properly, however, categorical variables need to be presented as character data, rather than numbers. Fortunately, there's an easy method for swapping the levels of your categorical variable, `TherapyGroup`, from numbers to words. If you assigned labels properly when completing [Experiment 1 Data Review], you can highlight the `TherapyGroup` column in your data, and click the 'Value Labels' button at the top:

```{r, echo = F, fig.align='center', out.width='50%'}
knitr::include_graphics('https://mtruelovehill.github.io/PRM/Labs/images/week6_variableFlip.png')
```

If you've added labels properly, you'll notice that the highlighted column will now have the labels rather than numeric values.


```{r, echo = F, fig.align='center', out.width='50%'}
knitr::include_graphics('https://mtruelovehill.github.io/PRM/Labs/images/week6_labelSwap.png')
```

Now, save your file. This updated file (with the labels in the `TherapyGroup` column) is what you will import into the ggplot GUI application.

### Your Task

+ [ ] $\ $ Using the ggplot GUI application, produce a boxplot with `TherapyGroup` on the x-axis and `CAPSFollowUp` on the y-axis. 

+ [ ] $\ $ Upload [these data](https://mtruelovehill.github.io/PRM/Labs/Week6LabData_Long.sav) into the ggplot GUI, and produce a boxplot with `Time` on the x-axis, `CAPS` on the y-axis, and `TherapyGroup` as Group/Color. 

<div class="container">
<details><summary><span style = "font-weight: bold; font-size: 16pt"> Click here for a hint </span></summary>

If you can't quite figure out the label swap, you can upload [this dataset](https://mtruelovehill.github.io/PRM/Labs/Week6LabData_TGnames.sav) to the ggplot GUI to produce your plot.
...
Upload the SPSS datafile into the ggplot GUI application by using Data Upload column on the left of the page. First, click the 'Browse' button to find the file on your device, selecting 'SPSS' under 'Type of File', then clicking 'Submit Datafile'.

```{r, echo = F, fig.align='center', out.width='50%'}
knitr::include_graphics('https://mtruelovehill.github.io/PRM/Labs/images/week6_ggplotUpload.png')
```

You'll see a sample of the data appear to the right. To generate a plot with these data, click the 'ggplot' option, here:

```{r, echo = F, fig.align='center', out.width='50%'}
knitr::include_graphics('https://mtruelovehill.github.io/PRM/Labs/images/week6_ggplotTab.png')
```

You'll define your plot in the column to the left. Under 'Type of graph', click 'Boxplot'. Set your Y-Variable to `CAPSFollowUp`, then set your X-Variable to `TherapyGroup`. To make the plot APA style, you'll need to look at the box to the right, 'Change aesthetics'. Click 'Theme', then select, 'classic'. You should also change the labels using the 'Text' tab. Tick 'change label axes', and label them appropriately (with proper spacing). I also recommend increasing the font size to at least 14 for axis titles and 12 for axis text. When you're finished, your plot should look something like this:

```{r, echo = F, fig.align='center', out.width='50%'}
knitr::include_graphics('https://mtruelovehill.github.io/PRM/Labs/images/week6_basicBoxplot.png')
```

You can click other tabs and set different options to see what other changes you can make to your plot. If you ever need to produce plots to use in a write-up (your dissertation, for example), you can click 'Download pdf of figure'. This will allow you to save your figure for use elsewhere.

<br>

To produce the more complex plot, upload the dataset in the same way as before. Don't forget to click 'Submit Datafile' once you've uploaded it. Once again, you'll be making a boxplot. This time, set `CAPS` as your Y-variable and `Time` as your X-variable. Set `TherapyGroup` as your Group (or color) variable. You can change the aesthetics as suggested above to make sure the plot is APA style. You can also change colors if you'd like. You should end up with something that looks similar to this:

```{r, echo = F, fig.align='center', out.width='50%'}
knitr::include_graphics('https://mtruelovehill.github.io/PRM/Labs/images/week6_advancedBoxplot.png')
```

Now you have an APA-style dissertation-ready figure!
...
To run an ANCOVA with a model with a within-subjects variable, navigate to *Analyze>General Linear Model>Repeated Measures*. Set up your IV and DVs as before (see the solution in [Experiment 1 Analysis] if you're unsure about this step). After you've added your variables, add `Age` to the 'Covariates' box:

```{r, echo = F, fig.align='center', out.width='50%'}
knitr::include_graphics('https://mtruelovehill.github.io/PRM/Labs/images/week6_ANCOVAsetup.png')
```


You can set your model using the same options as in [Experiment 1 Analysis]. When you're ready, click 'OK' to run the model.

```{r, echo = F, fig.align='center', out.width='50%'}
knitr::include_graphics('https://mtruelovehill.github.io/PRM/Labs/images/week6_ANCOVAwsEffects.png')
```
...
When interpreting results from ANCOVA, you should focus on the variables about which you've hypothesised (i.e., your IVs and DV). It's okay to briefly report whether or not your covariates are significant, but they should not be a strong focus of your results/discussion, and you only need to report the $p$-values. If there is a strong covariate effect and you think this has affected your hypothesised results, you might consider discussing it further in the discussion section, but it should be done in the context of your research aim and hypothesis. For example, in this this case, the methods/results write-ups might look something like this: 


<b> Example Report </b>

We performed a 2x2 ANCOVA with both one within-subjects variable, Time (levels: baseline; follow-up), and one between-subjects variable, therapy group (levels: Waitlist, VR Therapy) as independent variables and CAPS score as the dependent variable. We included participant age as a covariate. $\alpha$ was set at .05 for all analyses.

There was a significant effect of Therapy Group on CAPS score, $F$(1, 128) = 7.06, $p$ = .009, $\eta^2$ = .05. Specifically, participants in the waitlist group had higher CAPS scores than those in the VR therapy group. The effect of Time on CAPS scores was not significant, $F$(1, 128) = .738, $p$ = .392, $\eta^2$ = .006. Age, as a covariate, was not significant, $p$ = .428

There was a significant interaction between Time and Therapy Group on CAPS score, $F$(1, 128) = 17.77, $p$ < .001, $\eta^2$ = .12. Simple effects analyses indicated that while there was no significant effect of therapy group at baseline, $F$(1, 128) = 0.04, $p$ = .839, those in the waitlist group had significantly higher CAPS scores than those in the VR therapy group at follow-up, $F$(1, 128) = 17.10, $p$ < .001, $\eta^2$ = .11.

...
## Task 2: Calculate the Area Under the Curve
...
Maybe do one where we start to use scores on the x-axis, so they can start to see how some scores fall within an 'extreme' range. 

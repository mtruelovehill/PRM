...
```{r q2, echo = FALSE}
quiz(caption = 'Test Your Understanding',
     question("Which type of data is MemoryScore?",
              answer("Categorical"),
              answer("Continuous", correct = T),
              random_answer_order = T),
     question("Which type of data is Education?",
              answer("Continuous", correct = T),
              answer('Categorical')),
...
quiz(caption = 'Test Your Understanding',
     ...
     question_numeric("What is the average memory score?",
              answer(45.21, correct=T)),
     question_numeric("What is the most common age in this sample?",
              answer(78, correct=T)),
     question_numeric("What is the median years of education in this sample?",
              answer(15.5, correct=T))
)
```

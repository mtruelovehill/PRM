...
+ **Monica Truelove-Hill**
  ...
  + Room 1.5, Doorway 6
  + Office Hours: ADD OFFICE HOURS HERE
...
|:--------:|:---------------------------------------------|:-----------------------------------------------------|
|  1       | Intro to Null-Hypothesis Statistical Testing | Describing Data & Working with Distributions         |
|  2       | Effect Sizes & Power                         | Computing Effect Sizes & Conducting Power Analyses   |
|  3       | $t$ -tests                                   | Running & Interpreting $t$-tests; Boxplots           |
|  4       | ANOVA I                                      | One-Way and Repeated Measures ANOVA                  |
|  5       | ANOVA II                                     | Moderation with ANOVA                                |
| <B>6</B> |<B> Flexible Learning Week Review Session </B>| <B> No Lab </B>                                      |
...
|  11      | Thematic Analysis                            | Conducting a Thematic Analysis                       |
...
+ Optional (but **strongly** recommended)
  ...
  + Office Hours
  + Flexible Learning Week review session ***MONICA: MAYBE EDIT THIS**
...
+ **Group Qualitative Report (30% of mark)**
  + Released after Flexible Learning Week (TBC)
  + Due 9th December at noon
